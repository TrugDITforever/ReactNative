<<<<<<< HEAD:webAdmin/admin_web/src/components/Login.js
    ...
    return (
        <div className={styles.container}>
            <div className={styles.flexcontainer}>
                <div className={styles.coverimg}>
                    <div className={styles.imgbox}>
                        <img src="https://static.vecteezy.com/system/resources/previews/036/303/681/non_2x/ai-generated-chef-cooking-clipart-transparent-background-culinary-art-cooking-illustration-professional-chef-chef-hat-apron-chef-uniform-cooking-png.png"
                            alt="cooking art"
                            className={styles.imgcv}
                        />
                    </div>
                    <p className={styles.txtcover}>Start your journey to discover the amazing world of food!</p>
...
export default Login
>>>>>>> f39bb83 (login and register):React native/webAdmin/admin_web/src/components/Login.js
